...
|Po jednom spuštění procedury [Production].[MoveWorkOrder] je do tabulky WorkOrderRouting vložen nový řádek s hodnotami OperationSequence = 2 a LocationID = 20        | Test_WorkOrderRouting_Fake                  | test 02 UpdateWorkOrderRouting           | Production.MoveWorkOrder|
|Po pěti spuštěních procedury [Production].[MoveWorkOrder] je do tabulky WorkOrderRouting vloženo 5 nových řádků, poslední řádek s hodnotami OperationSequence = 5 a LocationID = 50     | Test_WorkOrderRouting_Fake| test 03 MultipleUpdateWorkOrderRouting   | Production.MoveWorkOrder|
...
| Testovací požadavek | Název TestClass v databázi AdventureWorks2019 | Název Testu v databázi AdventureWorks2019 | Testovaná procedura |
|---|---|---|---|
|Otestujte proceduru [Production].[CreateWorkOrder] nahrazením hodnot v hranatých závorkách vašimi hodnotami | Test_WorkOrderRouting_Fake | test 05 InsertWorkOrder NahradteVasimJmenem   | Production.CreateWorkOrder|
<br>
